...
public class MyNewsFragment extends Fragment {
    ...
    public static MyNewsFragment newInstance(String param1, String param2, String param3, String param4, String param5, String param6, int position) {
