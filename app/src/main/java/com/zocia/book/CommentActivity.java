...
import com.zocia.book.adapter.CommentsAdapter;
...
import com.zocia.book.model.UserPresenter;
...
public class CommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (screen == 1) {
            ...
            news_id = extra.getString("news_id");
        }
    ...
    private void initUi() {
        findViewById(R.id.layoutBack).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (screen == 4) {
                    Intent mIntent = new Intent(CommentActivity.this, NewsFeedActivity.class);
                    Bundle extra = getIntent().getBundleExtra("extra");

                    mIntent.putExtra("position", extra.getInt("position"));
                    startActivity(mIntent);
                    finish();
                } else if (screen == 5) {
                    Intent mIntent = new Intent(CommentActivity.this, MyNewsFeedActivity.class);
                    Bundle extra = getIntent().getBundleExtra("extra");
    ...
    private void ServerRequest() {
        ...
        if (screen == 1) {
            ...
            url = AllUrls.BASEURL + "newsCommentList";
            allHashMap.put("news_id", news_id);
    ...
    private void addPostServerRequest(String message, String userIds) {
        ...
        if (screen == 1) {
            ...
            url = AllUrls.BASEURL + "addComment";
            allHashMap.put("news_id", news_id);
        }
    ...
    private void leaverServerRequest(final int position) {
        ...
        if (screen == 1) {
            ...
            url = AllUrls.BASEURL + "newsCommentDelete";
            allHashMap.put("comment_id", mCommentsList.getId());
