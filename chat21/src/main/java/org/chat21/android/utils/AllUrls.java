...
public class AllUrls {
    ...
    public static String HTTP = "http://gracebookzone.com/gracebook/public/";
    //        public static String HTTP = "http://192.168.1.33/gracebook/public/";
    public static String BASEURL = HTTP + "apis/";
    public static String IMAGEURL = "http://admin1.gracebookzone.com/upload/mobileuser/profilepic/";
    //sudo php artisan serve --host 192.168.1.2 --port 80
