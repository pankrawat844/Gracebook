...
public class PrayRequestAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (viewHolder instanceof ItemViewHolder) {
            ...
            try {
                ...
                holder.location.setText(mJobList.getmUsersdata().getCity() + ", " + mJobList.getmUsersdata().getCountry());
                ...
                if (mJobList.isIs_like()) {
                    holder.IsLikemage.setImageResource(R.drawable.ic_baseline_star_24);
                } else {
                    holder.IsLikemage.setImageResource(R.drawable.ic_baseline_star_24_deselect);
                }
                holder.postInterest.setText(mJobList.getPost_interest());
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ItemViewHolder(View itemView) {
            ...
            postInterest = (TextView) itemView.findViewById(R.id.interst);
    ...
    private void ServerRequest(final int position) {
        ...
        final String url = AllUrls.BASEURL + "prayeraddLike";
